...
function Student(id, firstName, secondName, age, description, gender) {
    var self = this;
    ...
    self.addStudent = function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                studentRegisterViewModel.studentListViewModel.students.push(new Student(data.Id, data.FirstName, data.SecondName, data.Age, data.Description, data.Gender));
    ...
    self.getStudents = function () {
        ...
        $.getJSON('/api/student', function (data) {
            $.each(data, function (key, value) {
                self.students.push(new Student(value.Id, value.FirstName, value.SecondName, value.Age, value.Description, value.Gender));
            });
        });
    };
